<template>
  <div
    class="w-full text-left bg-white dark:bg-gray-900 text-white max-w-7xl mx-auto py-10 px-4 sm:py-14 sm:px-6 lg:px-8"
  >
    <div class="p-20">
      <h1 class="text-4xl text-center pb-10">TERMS AND CONDITIONS</h1>
      <p class="sm:text-lg pb-6 text-justify">
        These Terms of Use describe the legally binding terms and conditions that oversee your use
        of the Site. <strong>BY LOGGING INTO THE SITE, YOU ARE AGREEING TO THESE TERMS</strong> and
      ...
      <h1 class="text-3xl text-center pb-10">Access to the Site</h1>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Subject to these Terms. </b>The Free Computer Science Project grants you a
        non-transferable, non-exclusive, revocable, limited license to access the Site solely for
        your own personal, noncommercial use.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Certain Restrictions.</b> The rights approved to you in these Terms are subject to the
        following restrictions outlined in the Creative Commons Attribution-NonCommercial-ShareAlike
        4.0 International License, any future release, update, or other addition to functionality of
      ...
      <p class="sm:text-lg pb-6 text-justify">
        The Free Computer Science Project reserves the right to change, suspend, or cease the Site
        with or without notice to you. You approved that The Free Computer Science Project will not
        be held liable to you or any third-party for any change, interruption, or termination of the
        Site or any part.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>No Support or Maintenance.</b> You agree that The Free Computer Science Project will have
      ...
      <p class="sm:text-lg pb-6 text-justify">
        ...
        and its content are owned by The Free Computer Science Project or The Free Computer Science
        Project's suppliers. Note that these Terms and access to the Site do not give you any
        rights, title or interest in or to any intellectual property rights, except for the limited
        access rights expressed in Section 2.1. The Free Computer Science Project and its suppliers
        reserve all rights not granted in these Terms.
      </p>
      <h1 class="text-3xl text-center pb-10">Third-Party Links & Ads; Other Users</h1>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Third-Party Links & Ads. </b>The Site may contain links to third-party websites and
        services, and/or display advertisements for third-parties. Such Third-Party Links & Ads are
        not under the control of The Free Computer Science Project, and The Free Computer Science
        Project is not responsible for any Third-Party Links & Ads. The Free Computer Science
        Project provides access to these Third-Party Links & Ads only as a convenience to you, and
      ...
      <p class="sm:text-lg pb-6 text-justify">
        <b>Other Users.</b> Each Site user is solely responsible for any and all of its own User
        Content. Because we do not control User Content, you acknowledge and agree that we are not
        responsible for any User Content, whether provided by you or by others. You agree that The
        Free Computer Science Project will not be responsible for any loss or damage incurred as the
        result of any such interactions. If there is a dispute between you and any Site user, we are
        under no obligation to become involved.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        You hereby release and forever discharge the The Free Computer Science Project and our
        officers, employees, agents, successors, and assigns from, and hereby waive and relinquish,
        each and every past, present and future dispute, claim, controversy, demand, right,
        obligation, liability, action and cause of action of every kind and nature, that has arisen
        or arises directly or indirectly out of, or that relates directly or indirectly to, the
        Site. If you are a California resident, you hereby waive California civil code section 1542
      ...
      <p class="sm:text-lg pb-6 text-justify">
        <b>Cookies and Web Beacons.</b> Like any other website, The Free Computer Science Project
        uses 'cookies'. These cookies are used to store information including visitors' preferences,
      ...
      <h1 class="text-3xl text-center pb-10">Disclaimers</h1>
      <p class="sm:text-lg pb-6 text-justify">
        The site is provided on an "as-is" and "as available" basis, and The Free Computer Science
        Project and our suppliers expressly disclaim any and all warranties and conditions of any
        ...
        non-infringement. We and our suppliers make no guarantee that the site will meet your
      ...
      <h1 class="text-3xl text-center pb-10">Limitation on Liability</h1>
      <p class="sm:text-lg pb-6 text-justify">
        To the maximum extent permitted by law, in no event shall The Free Computer Science Project
        or our suppliers be liable to you or any third-party for any lost profits, lost data, costs
        ...
        of, or incapability to use the site even if The Free Computer Science Project has been
      ...
      <p class="sm:text-lg pb-6 text-justify">
        <b>Term and Termination.</b> Subject to this Section, these Terms will remain in full force
        ...
        Account from our live databases. The Free Computer Science Project will not have any
        liability whatsoever to you for any termination of your rights under these Terms. Even after
        your rights under these Terms are terminated, the following provisions of these Terms will
        remain in effect: Sections 2 through 2.5, Section 3 and Sections 4 through 10.
      </p>
      <h1 class="text-3xl text-center pb-10">Copyright Policy.</h1>
      <p class="sm:text-lg pb-6 text-justify">
        The Free Computer Science Project respects the intellectual property of others and asks that
        users of our Site do the same. In connection with our Site, we have adopted and implemented
        a policy respecting copyright law that provides for the removal of any infringing materials
        and for the termination of users of our online Site who are repeat infringers of
        intellectual property rights, including copyrights. If you believe that one of our users is,
        through the use of our Site, unlawfully infringing the copyright(s) in a work, and wish to
        have the allegedly infringing material removed, the following information in the form of a
        written notification (pursuant to 17 U.S.C. § 512(c)) must be provided to our designated
        Copyright Agent:
      
      <ul class="items-center text-justify ml-12 mr-12 pb-6 sm:text-lg">
      ...
      <p class="sm:text-lg pb-6 text-justify">Such correspondences can be sent to freecompsci@gmail.com</p>
      <p class="sm:text-lg pb-6 text-justify">
      ...
      <h1 class="text-3xl text-center pb-10">General</h1>
      <p class="sm:text-lg pb-6 text-justify">
        ...
        part of your contract with The Free Computer Science Project and affects your rights. It
        contains procedures for MANDATORY BINDING ARBITRATION AND A CLASS ACTION WAIVER.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Applicability of Arbitration Agreement.</b> All claims and disputes in connection with
        the Terms or the use of any product or service provided by the The Free Computer Science
        Project that cannot be resolved informally or in small claims court shall be resolved by
        ...
        Arbitration Agreement applies to you and The Free Computer Science Project, and to any
      ...
      <p class="sm:text-lg pb-6 text-justify">
        <b>Notice Requirement and Informal Dispute Resolution.</b> Before either party may seek
        ...
        to the The Free Computer Science Project should be sent to contact@theodinproject.com. After
        the Notice is received, you and The Odin Project may attempt to resolve the claim or dispute
        informally. If you and The Free Computer Science Project do not resolve the claim or dispute
        ...
        arbitrator until after the arbitrator has determined the amount of the award to which either
        party is entitled.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Arbitration Rules.</b> Arbitration shall be initiated through the American Arbitration
        ...
        aspects of the arbitration except to the extent such rules are in conflict with the Terms.
        The AAA Consumer Arbitration Rules governing the arbitration are available online at adr.org
        ...
        is greater than the last settlement offer that the The Odin Project made to you prior to the
        initiation of arbitration, the The Free Computer Science Project will pay you the greater of
        the award or $2,500.00. Each party shall bear its own costs and disbursements arising out of
        the arbitration and shall pay an equal share of the fees and costs of the ADR Provider.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Additional Rules for Non-Appearance Based Arbitration.</b> If non-appearance based
      ...
      <p class="sm:text-lg pb-6 text-justify">
        <b>Time Limits.</b> If you or the The Free Computer Science Project pursues arbitration, the
      ...
      <p class="sm:text-lg pb-6 text-justify">
        ...
        rights and liabilities of you and The Free Computer Science Project, and the dispute will
        not be consolidated with any other matters or joined with any other cases or parties. The
        ...
        Free Computer Science Project.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Waiver of Jury Trial.</b> THE PARTIES HEREBY WAIVE THEIR CONSTITUTIONAL AND STATUTORY
        ...
        Arbitration procedures are typically more limited, more efficient and less expensive than
        rules applicable in a court and are subject to very limited review by a court. In the event
        any litigation should arise between you and the The Free Computer Science Project in any
        state or federal court in a suit to vacate or enforce an arbitration award or otherwise, YOU
        AND THE The Free Computer Science Project WAIVE ALL RIGHTS TO A JURY TRIAL, instead electing
        that the dispute be resolved by a judge.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Waiver of Class or Consolidated Actions. </b>All claims and disputes within the scope of
        this arbitration agreement must be arbitrated or litigated on an individual basis and not on
        a class basis, and claims of more than one customer or user cannot be arbitrated or
      ...
      <p class="sm:text-lg pb-6 text-justify">
        <b>Severability.</b> If any part or parts of this Arbitration Agreement are found under the
        law to be invalid or unenforceable by a court of competent jurisdiction, then such specific
        part or parts shall be of no force and effect and shall be severed and the remainder of the
        Agreement shall continue in full force and effect.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Right to Waive.</b> Any or all of the rights and limitations set forth in this
      ...
      <p class="sm:text-lg pb-6 text-justify">
        S<b>urvival of Agreement.</b> This Arbitration Agreement will survive the termination of
        your relationship with The Free Computer Science Project.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Small Claims Court.</b> Nonetheless the foregoing, either you or the The Free Computer
        Science Project may bring an individual action in small claims court.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Emergency Equitable Relief. </b>Anyhow the foregoing, either party may seek emergency
      ...
      <p class="sm:text-lg pb-2 text-justify">
        <b>Claims Not Subject to Arbitration.</b> Notwithstanding the foregoing, claims of
      ...
      <p class="sm:text-lg pb-2 text-justify">
        ...
        courts located within US County, California, for such purposes.
      </p>
      <p class="sm:text-lg pb-2 text-justify">
        ...
        indirectly, any U.S. technical data acquired from The Free Computer Science Project, or any
      ...
      <p class="sm:text-lg pb-6 text-justify">
        ...
        of the Division of Consumer Product of the California Department of Consumer Affairs by
        contacting them in writing at 400 R Street, Sacramento, CA 95814, or by telephone at (800)
        952-5210.
      </p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Electronic Communications.</b> The communications between you and The Free Computer
        Science Project use electronic means, whether you use the Site or send us emails, or whether
        The Free Computer Science Project posts notices on the Site or communicates with you via
        email. For contractual purposes, you (a) consent to receive communications from The Free
        Computer Science Project in an electronic form; and (b) agree that all terms and conditions,
        agreements, notices, disclosures, and other communications that The Odin Project provides to
      ...
      <p class="sm:text-lg pb-6 text-justify">
        <b>Entire Terms.</b> These Terms constitute the entire agreement between you and us
        ...
        "including" means "including without limitation". If any provision of these Terms is held to
        ...
        enforceable to the maximum extent permitted by law. Your relationship to The Free Computer
        Science Project is that of an independent contractor, and neither party is an agent or
        partner of the other. These Terms, and your rights and obligations herein, may not be
        assigned, subcontracted, delegated, or otherwise transferred by you without The Free
        Computer Science Project's prior written consent, and any attempted assignment, subcontract,
        delegation, or transfer in violation of the foregoing will be null and void. The Free
        Computer Science Project may freely assign these Terms. The terms and conditions set forth
        in these Terms shall be binding upon assignees.
      </p>
      <p class="sm:text-lg pb-6 text-justify"><b>Your Privacy.</b> Please read our Privacy Policy.</p>
      <p class="sm:text-lg pb-6 text-justify">
        <b>Copyright/Trademark Information.</b> Copyright ©. All rights reserved. All trademarks,
        logos and service marks displayed on the Site are our property or the property of other
        third-parties. You are not permitted to use these Marks without our prior written consent or
